...
hcaluTCATask = cms.EDAnalyzer(
	...
	MEs					= cms.untracked.PSet(
		...
		HFuTCAShape				= cms.untracked.PSet(
			path	= cms.untracked.string("Hcal/%s/HF" % moduleName),
			kind	= cms.untracked.string("TH1D"),
			desc	= cms.untracked.string("HF uTCA Shape"),
			xaxis	= cms.untracked.PSet(
				edges	= cms.untracked.bool(False),
				nbins	= cms.untracked.int32(10),
				min		= cms.untracked.double(0.),
		...
		HOuTCAShape				= cms.untracked.PSet(
			path	= cms.untracked.string("Hcal/%s/HO" % moduleName),
			kind	= cms.untracked.string("TH1D"),
			desc	= cms.untracked.string("HO uTCA Shape"),
			xaxis	= cms.untracked.PSet(
				edges	= cms.untracked.bool(False),
				nbins	= cms.untracked.int32(10),
				min		= cms.untracked.double(0.),
		...
		uTCASizeCheck			= cms.untracked.PSet(
			path	= cms.untracked.string("Hcal/%s/" % moduleName),
			kind	= cms.untracked.string("TH2D"),
			desc	= cms.untracked.string("uTCA Size Check for SubSystems"),
			xaxis	= cms.untracked.PSet(
				edges	= cms.untracked.bool(False),
			...
			yaxis	= cms.untracked.PSet(
				...
				title	= cms.untracked.string("uTCA Size")
			)
		),
