//	cmssw includes
#include "DQM/HcalTasks/interface/HcalPhaseScanTask.h"

//	system includes
#include <iostream>
#include <string>

HcalPhaseScanTask::HcalPhaseScanTask(edm::ParameterSet const&ps):
	hcaldqm::HcalDQSource(ps)
{}

/* virtual */ HcalPhaseScanTask::~HcalPhaseScanTask()
{
}

/* virtual */void HcalPhaseScanTask::beginLuminosityBlock(
		edm::LuminosityBlock const& lb, edm::EventSetup const& es)
{
	HcalDQSource::beginLuminosityBlock(lb, es);
}

/* virtual */void HcalPhaseScanTask::endLuminosityBlock(
		edm::LuminosityBlock const& lb, edm::EventSetup const& es)
{
	HcalDQSource::endLuminosityBlock(lb, es);
}

/* virtual */ void HcalPhaseScanTask::doWork(edm::Event const& e,
...
/* virtual */void HcalPhaseScanTask::reset(int const periodflag)
{
...
void HcalPhaseScanTask::hf(HFDataFrame const& digi)
{
...
DEFINE_FWK_MODULE(HcalPhaseScanTask);
