...
#'/nfshome0/hcaldqm/DQM_OUTPUT/ChannelStatus/' # set to empty to suppress channel status output
...
#process.GlobalTag = gtCustomise(process.GlobalTag, 'GR_P_V49', '')

#	Needed to fix crashing	
process.GlobalTag.globaltag = 'GR_E_V42::All'

#	Provide a utca unpacker
