/** \class EcalRecHitProducerGPU
 *   produce ECAL rechits from uncalibrated rechits
 *
 *  \author Shahram Rahatlou, University of Rome & INFN, March 2006
 *
 **/
#include "RecoLocalCalo/EcalRecProducers/plugins/EcalRecHitProducerGPU.h"
...
void
EcalRecHitProducerGPU::produce(edm::Event& evt, const edm::EventSetup& es)
{
        using namespace edm;
                ...
                if ( detIds ) {
                        ...
                        for( std::set<EBDetId>::const_iterator it = detIds->begin(); it != detIds->end(); ++it ) {
                                ...
                                if ( chit != chStatus->end() ) {
                                        ...
                                        edm::LogError("EcalRecHitProducerGPUError") << "No channel status found for xtal "
                                                << (*it).rawId()
...
void EcalRecHitProducerGPU::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
