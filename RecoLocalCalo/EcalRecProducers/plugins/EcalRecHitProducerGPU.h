#ifndef RecoLocalCalo_EcalRecProducers_EcalRecHitProducerGPU_hh
#define RecoLocalCalo_EcalRecProducers_EcalRecHitProducerGPU_hh
...
class EcalRecHitProducerGPU : public edm::stream::EDProducer<> {
        ...
        public:
                explicit EcalRecHitProducerGPU(const edm::ParameterSet& ps);
