...
HcalSiPMParametersGPU::HcalSiPMParametersGPU(HcalSiPMParameters const& parameters) 
    : totalChannels_{parameters.getAllContainers()[0].second.size()
