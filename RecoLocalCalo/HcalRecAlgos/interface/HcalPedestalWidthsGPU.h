...
public:
    struct Product {
        ~Product();
        float *sigma00, *sigma01, *sigma02, *sigma03,
              *sigma10, *sigma11, *sigma12, *sigma13,
              *sigma20, *sigma21, *sigma22, *sigma23,
              *sigma30, *sigma31, *sigma32, *sigma33;
    };
...
private:
    ...
    std::vector<float, CUDAHostAllocator<float>> 
        ...
        sigma30_, sigma31_, sigma32_, sigma33_;
