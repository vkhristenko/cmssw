#ifndef HcalRawToDigiGPU_h
#define HcalRawToDigiGPU_h

/** \class HcalRawToDigiGPU
 *
 * HcalRawToDigiGPU is the EDProducer subclass which runs 
...
{
public:
  explicit HcalRawToDigiGPU(const edm::ParameterSet& ps);
