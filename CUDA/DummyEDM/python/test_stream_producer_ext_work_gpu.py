...
#
process = cms.Process("TestGPUExtWork")
...
#
process.testGPU = cms.EDProducer('DummyStreamProducerExtWorker',
...
process.out = cms.OutputModule(
    "PoolOutputModule",
    fileName = cms.untracked.string("test_streamproducer_ext_work.root")
)
